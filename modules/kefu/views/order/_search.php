...
<div class="order-search">
    ...
    <!--?= $form->field($model, 'id') ?-->
	<div class="row">
		<div class="col-lg-3"> <?= $form->field($model, 'order_no') ?> </div>
	...
	<div class="col-lg-3"><?php  echo $form->field($model, 'contact_name') ?></div>
  <div class="col-lg-3"><?php  echo $form->field($model, 'contact_phone') ?></div>
  <div class="col-lg-3">  <?php  echo $form->field($model, 'order_addr') ?> </div>
	</div>
